...
<html>
    <head>
        ...
        <link href="bootstrap-timepicker/css/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css"/>
                ...
                <div id="menubar">
                    <ul id="nav">
                        ...
                        <li><a href="contact.jsp">Contact Us</a></li>
                            <%if (utype == 1) {%>
                        <li class="current" ><a href="addflights.jsp">Add flights</a></li>
            ...
            <div id="site_content">		
                ...
                <div id="content" style="width:915px;">
                    <div class="content_item" style="width:915px;">
                        ...
                        <form class="form-horizontal" id="transferform" method="POST" action="addflights" >

                            <div class="form-group">
                                <label for="" class="col-sm-4 control-label newfont" >Flight number</label>
                                <div class="col-sm-6">
                                    <input type="text" name="fnumber" class="form-control input-sm" required id="inputName" placeholder="Flight number">
                                </div>
                            </div>
                            <div class="form-group" >
                            ...
                            <!--                            <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6" >
                                                                <input readonly type="text" class="form-control input-sm" id="fdate">                                     
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label newfont">Flight Time </label>
                                                            <div class="col-sm-6" >
                                                                <input readonly type="text" class="form-control input-sm" id="ftime">                                     
                                                            </div>
                                                        </div>-->
                            <div class="form-group">
                                <label for="" class="col-sm-4 control-label newfont" >Total flight time</label>
                                <div class="col-sm-6" >
                                    <input type="text" id="redate" name="fduration" class="form-control input-sm" required placeholder="Total flight time">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-4 control-label newfont" >Price</label>
                                <div class="col-sm-6" >
                                    <input type="number" name="price" class="form-control input-sm" required  placeholder="Price">
                                </div>
                            </div>
